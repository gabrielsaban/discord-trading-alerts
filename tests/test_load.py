...
class TestLoadPerformance:
    ...
    def test_database_concurrent_access(self):
            ...
            try:
                ...
                for _ in range(n_operations):
                    ...
                    if operation == "add":
                        ...
                        db.update_user_settings(user_id, {"rsi_oversold": random.randint(20, 40)})
        ...
        logger.info(f"Database load test: {n_threads} threads * {n_operations} operations = {n_threads * n_operations} total operations")
    ...
    def test_concurrent_api_requests(self, mock_get):
        ...
        assert successful == n_requests, f"Only {successful}/{n_requests} requests succeeded" 