...
class TestBinanceAPI:
    ...
    def test_successful_api_response(self, mock_get):
        ...
        assert df['open'].iloc[0] == 40000, "First candle should have open price of 40000"
    ...
    def test_http_error_response(self, mock_get):
        ...
        mock_response.raise_for_status.side_effect = RequestException("400 Client Error: Bad Request")
        mock_get.return_value = mock_response
    ...
    def test_malformed_response(self, mock_get):
        ...
        malformed_data = [
            ...
            [1627776000000, "40000"],
            # Wrong data types
            [1627779600000, "not_a_number", "41000", "39500", "40500", "100", 1627779599999, "4050000", 1000, "50", "2025000", "0"],
        ]
    ...
    def test_rate_limit_response(self, mock_get):
        ...
        mock_response.json.return_value = {"code": -1003, "msg": "Too many requests; IP banned"}
        mock_response.raise_for_status.side_effect = RequestException("429 Client Error: Too Many Requests")
        mock_get.return_value = mock_response
    ...
    def test_server_error_response(self, mock_get):
        ...
        mock_response.raise_for_status.side_effect = RequestException("500 Server Error: Internal Server Error")
        mock_get.return_value = mock_response
