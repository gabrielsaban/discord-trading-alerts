...
class TestDatabaseManager:
    ...
    def test_user_management(self, in_memory_db):
        ...
        # Update settings
        new_settings = {"rsi_oversold": 25, "new_setting": "test"}
    ...
    def test_watchlist_management(self, in_memory_db):
        ...
        watchlist_with_inactive = in_memory_db.get_user_watchlist(
    ...
    def test_alert_management(self, in_memory_db):
        ...
        in_memory_db.record_alert(
            user_id, "BTCUSDT", "15m", "rsi", "RSI ALERT: BTCUSDT"
        )
        in_memory_db.record_alert(
            user_id, "ETHUSDT", "1h", "macd", "MACD ALERT: ETHUSDT"
        )
    ...
    def test_symbol_and_user_queries(self, in_memory_db):
        ...
        expected_symbols = [("BTCUSDT", "15m"), ("ETHUSDT", "15m"), ("BNBUSDT", "1h")]
